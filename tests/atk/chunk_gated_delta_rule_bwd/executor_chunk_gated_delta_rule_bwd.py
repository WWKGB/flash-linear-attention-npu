...
def run_npu(spec: dict[str, Any], input_data: InputDataset):
    ...
    outputs = ascendc.npu_chunk_gated_delta_rule_bwd(
        ...
        _public_layout(inputs["g"], sequence_major),
        _public_layout(inputs["beta"], sequence_major),
        inputs["A"],
        _public_layout(inputs["d_o"], sequence_major),
        inputs["scale"], CHUNK_SIZE, layout=layout,
        initial_state=initial_state, dht=dht,
        q_rstd=_public_layout(inputs["q_rstd"], sequence_major),
        k_rstd=_public_layout(inputs["k_rstd"], sequence_major),
        beta_raw=_public_layout(inputs["beta_raw"], sequence_major),
